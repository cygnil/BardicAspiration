...
echo " 2. Populate 'campaigns/<campaign_name>/campaign_registry.json' using 'bin/create_campaign.py'"
echo " 3. Run the master tools:"
echo "    bin/transcribe.py /path/to/session.mp3 <campaign_name> <session_num>"
echo "    bin/extract_samples.py <campaign_name> <session_num>"
echo "    bin/annotate.py <campaign_name> <session_num>"
